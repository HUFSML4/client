...
export const getRecommendMovies = async (navigate, movieTitle, recommendType) => {
    await serverApi.post(`https://port-0-hufsml-1gksli2alpnlcd7w.sel4.cloudtype.app/searching/recommend/${movieTitle}/`, {"recommend_type": recommendType}).then((response) => {
