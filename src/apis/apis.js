...
export const searchMovies = async (keyword) => {
    let currMovies;
    await serverApi.post(`https://3.36.128.245:8000/searching/`, {"text":keyword}).then((response) => {
...
export const getRecommendMovies = async (navigate, movieTitle) => {
    await serverApi.get(`https://3.36.128.245:8000/searching/recommend/${movieTitle}/`).then((response) => {
